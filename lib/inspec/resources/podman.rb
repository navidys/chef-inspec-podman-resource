...
module Inspec::Resources
  ...
  class Podman < Inspec.resource(1)
    ...
    desc "A resource to retrieve information about podman (daemonless container engine)"
    ...
    def initialize
      skip_resource "The `podman` resource is not yet available on your OS." unless inspec.os.linux?
    end
    ...
    def version
      ...
      @version = Hashie::Mash.new(data['Client'])
